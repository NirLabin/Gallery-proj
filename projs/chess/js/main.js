...
function getAllPossibleCoordsKnight(pieceCoord) {
  var res = [];
  var iPos = pieceCoord.i;
  var jPos = pieceCoord.j;
  if (iPos + 2 < 8) {
    if (jPos + 1 < 8 && isEmptyCell({ i: iPos + 2, j: jPos + 1 }))
      res.push({ i: iPos + 2, j: jPos + 1 });
    if (jPos - 1 >= 0 && isEmptyCell({ i: iPos + 2, j: jPos - 1 }))
      res.push({ i: iPos + 2, j: jPos - 1 });
  }
  if (iPos - 2 >= 0) {
    if (jPos + 1 < 8 && isEmptyCell({ i: iPos - 2, j: jPos + 1 }))
  ...
  if (jPos + 2 < 8) {
    if (iPos + 1 < 8 && isEmptyCell({ i: iPos + 1, j: jPos + 2 }))
      res.push({ i: iPos + 1, j: jPos + 2 });
    if (iPos - 1 >= 0 && isEmptyCell({ i: iPos - 1, j: jPos + 2 }))
      res.push({ i: iPos - 1, j: jPos + 2 });
  }
  if (jPos - 2 >= 0) {
    if (iPos + 1 < 8 && isEmptyCell({ i: iPos + 1, j: jPos - 2 }))
